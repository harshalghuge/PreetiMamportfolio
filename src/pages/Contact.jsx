...
export const Contact = () => {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-[240px] md:h-[380px]  flex items-center justify-center overflow-hidden">
        <div
  ...
  <div className="max-w-5xl mx-auto px-6 lg:px-12">
    <div className="rounded-[40px] border border-stone-200 bg-white px-8 py-10 md:px-14 md:py-12 shadow-[0_24px_80px_rgba(39,33,28,0.09)]">
    ...
    <div className="mt-8 text-center">
      <h3 className="font-semibold text-stone-700 mb-4 text-sm tracking-wide uppercase">
        Follow Me
      </h3>
