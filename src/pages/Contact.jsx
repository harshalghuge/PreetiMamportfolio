    ...
    <div className="bg-white">
      ...
      <section className="relative h-[380px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-4xl">
          ...
          <p className="text-xl md:text-2xl font-light leading-relaxed">
            Whether you're ready to begin or just have questions, I'm here to listen and support you on your journey.
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-stone-300 rounded-lg focus:ring-2 focus:ring-stone-400 focus:border-transparent outline-none transition-all"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 border border-stone-300 rounded-lg focus:ring-2 focus:ring-stone-400 focus:border-transparent outline-none transition-all bg-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows="6"
                    className="w-full px-4 py-3 border border-stone-300 rounded-lg focus:ring-2 focus:ring-stone-400 focus:border-transparent outline-none transition-all resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-stone-900 text-white py-4 px-8 rounded-lg font-medium text-lg hover:bg-stone-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="lg:pl-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4 p-6 bg-stone-50 rounded-lg hover:bg-stone-100 transition-colors">
                  ...
                  <div>
                    ...
                    <a href="mailto:preeti@example.com" className="text-stone-600 hover:text-stone-900 transition-colors">
                      preeti@example.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-6 bg-stone-50 rounded-lg hover:bg-stone-100 transition-colors">
                  ...
                  <div>
                    ...
                    <a href="tel:+919876543210" className="text-stone-600 hover:text-stone-900 transition-colors">
                      +91 98765 43210
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-stone-200 rounded-full flex items-center justify-center hover:bg-stone-900 hover:text-white transition-all">
      ...
      <section className="relative h-[500px] overflow-hidden">
        <div 
          className="absolute inset-0 bg-cover bg-center bg-fixed"
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1569336415962-a4bd9f69cd83?q=80&w=2070&auto=format&fit=crop')"
          }}
        >
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-stone-600 leading-relaxed">
                Individual therapy sessions typically last 50-60 minutes. Movement therapy sessions may run 75-90 minutes depending on the approach.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-stone-600 leading-relaxed">
                Yes, I offer secure video sessions for clients who prefer remote therapy or cannot visit in person.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-stone-600 leading-relaxed">
                The first session is about getting to know each other, understanding what brings you to therapy, and discussing your goals and expectations.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-stone-600 leading-relaxed">
                Absolutely. Everything discussed in our sessions is completely confidential, with only a few legal exceptions which I'll explain during our first meeting.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-6 text-white">
          ...
          <p className="text-xl text-stone-200 mb-10 max-w-2xl mx-auto leading-relaxed">
            Your journey towards healing and self-discovery begins with a conversation. I'm here to walk alongside you.
          </p>
