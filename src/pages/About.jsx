          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div>
              ...
              <div className="space-y-6 text-stone-600 text-lg leading-relaxed">
                <p>
                  I'm a psychotherapist specializing in expressive movement
                  therapy, with a unique background that bridges the worlds of
                  spatial design and mental health.
                </p>
                <p>
                  For 18 years, I shaped physical spaces; now, I help people
                  reshape their inner landscapes. My work is rooted in the
                  belief that healing happens not just through words, but
                  through the body's wisdom and creative expression.
                </p>
                <p>
                  Every person carries their own story, their own rhythm. My
                  role is to create a safe space where you can explore, express,
                  and transform.
                </p>
              </div>
            </div>
