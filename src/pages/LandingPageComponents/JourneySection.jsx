...
export default function JourneySection() {
  ...
  return (
    <>
      ...
      <div ref={sectionRef} className="lg:hidden px-4 w-full overflow-x-hidden">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-16">
           ...
           <div className="h-[2px] bg-gradient-to-r from-transparent via-[#8B7355] to-transparent transition-all duration-1000 delay-300 w-full opacity-100"></div>
          </div>
        ...
        <div className="sticky top-0 flex items-center justify-center overflow-hidden">
          <div className="w-full max-w-7xl mx-auto px-16  py-2 lg:py-10">
            ...
            <div className="text-center mb-16">
              ...
              <div className="h-[3px] bg-gradient-to-r w-[25rem] mx-auto from-transparent via-[#8B7355] to-transparent transition-all duration-1000 delay-300 opacity-100 mt-3"></div>
            </div>
            ...
            <div className="relative w-full">
              ...
              <div className="relative flex justify-between items-center" style={{ minHeight: '400px' }}>
                ...
                {journeyItems.map((item, index) => {
                  ...
                  return (
                    <div key={index} className="relative flex flex-col items-center" style={{ flex: '0 0 auto', width: '16.666%' }}>
                      {/* Content Above Line */}
                      {item.side === "left" ? (
                        <motion.div
                          style={{ opacity, y }}
